      ...
      <table class="table table-striped b-t b-light">
        ...
        @foreach($all_brand_product as $key =>$cate_pro)
          <tr>
            ...
            {?>
              <a href="{{URL::to('/onactive-brand-product/'.$cate_pro->brand_id)}}"><i class="fa fa-eye"></i></a>
            <?php
            }
            else  
            {?>
           ...
           <?php
            ...
            <td>
              ...
              <a onclick="return confirm('Are you sure to Delete?');" href="{{URL::to('/delete-brand-product/'.$cate_pro->brand_id)}}" class="active" ui-toggle-class="">
